...
"" Methylated.vim is a minimal env/plugin/flavor vim [cfg/pkg] manager
function! PrecursorStructure()
  set mat=5
  set nolist
  set number
  set nowrap
...
function! PrecursorsChilliPepper()
	set tags=./tags,tags
...
function! Methylate()
	call PrecursorStructure()
"	call PrecursorSteal()
"	call PrecursorChilliPepper()
"	call Synthesize()
endfunction
